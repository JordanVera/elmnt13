...
export function HomeAbout() {
  return (
    <section className="relative overflow-hidden bg-paper px-6 py-28 md:py-36">
      <p
        aria-hidden="true"
        className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-display text-[38vw] leading-none text-gold/[0.07] select-none"
      >
        E13
      </p>
      <div className="relative mx-auto max-w-6xl">
        ...
        <Reveal delay={120}>
          <p className="mt-10 max-w-xl text-lg leading-8 text-ink/75">
            ...
            how every brand element matters and handle the creative direction and
