...
export function HomeAbout() {
  return (
    <section className="relative overflow-hidden bg-white px-6 py-20 md:py-24">
      <p
        aria-hidden="true"
        className="pointer-events-none absolute top-1/2 right-[4%] -translate-y-1/2 pr-[0.12em] font-serif text-[38vw] leading-none text-gold/20 select-none"
      >
        E13
      </p>
        ...
        <div className="md:col-span-7">
          ...
          <Reveal>
            <h2 className="mt-6 max-w-xl text-6xl leading-[0.86] tracking-tight uppercase md:text-7xl lg:text-8xl">
              <span className="font-display">We Take your</span>
              <br />
              <span className="font-bebas font-bold">Vision</span>
              <br />
              <span className="font-serif normal-case">further</span>
            </h2>
          </Reveal>
        </div>
